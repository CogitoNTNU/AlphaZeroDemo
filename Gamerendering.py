...
agent1 = ResNet.ResNet.build(6, 7, 2, 128, 7, num_res_blocks=10)


# agent1.load_weights("Models/FourInARow/10_3_10.h5")
        ...
        while True:
            ...
            if self.game.is_final():
                ...
                for event in pygame.event.get():
                    ...
                    numbers=[pygame.K_1, pygame.K_2, pygame.K_3, pygame.K_4, pygame.K_5, pygame.K_6, pygame.K_7]

                    if event.type == pygame.QUIT or pressed[27]:  # Escape quits the game
                        sys.exit()
                ...
                print(tree.get_prior_probabilities(self.game.get_state()).round(2))
                print(tree.get_posterior_probabilities(self.game.get_state()), tree.get_value(self.game.get_state()))
                ...
                self.game.execute_move(tree.get_most_searched_move(self.game.get_state()))
                self.update_screen()
